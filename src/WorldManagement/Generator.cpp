...
// void Generator::set(SeedType seed, const ResourceCache& resourceCache)
// { 
// 	m_seed = seed; 
...
// 	m_relevantBlockIds[static_cast<uint32_t>(BlockTypes::Air)] = resourceCache.getVoxelStateCache().getId("empty");
// 	m_relevantBlockIds[static_cast<uint32_t>(BlockTypes::Dirt)] = resourceCache.getVoxelStateCache().getId("dirt_block");
// 	m_relevantBlockIds[static_cast<uint32_t>(BlockTypes::Grass)] = resourceCache.getVoxelStateCache().getId("grass_block");
// }
